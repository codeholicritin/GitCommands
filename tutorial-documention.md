...
> [!Note]
> If you encounter issues with importing the theme demo, ensure you have followed the [General Requirements for the Ostnica Theme](tutorial-documentation.md#2-general-requirements-of-ostnica-theme).
